...
extern "C" void app_main(void) {
    ...
    // Build-only smoke: no Ethernet driver is installed on CI hardware. Keep the
    // objects live so headers, adapter symbols and C++20 span usage are compiled
    // and linked for the real ESP32-P4 toolchain.
    (void)port;
    (void)clock;
    (void)wrote;
}
