# IEDScout Server Golden Profile
...
Golden capture: `IEDScout_As_Server_Discovery.pcapng`  
SHA-256: `6f90cb4aa87326f07d569ebf40575d15841831259cc52e21f2e847b86d11ab99`

The capture records OMICRON IEDScout operating as the IEC 61850 server for the same SIPROTEC engineering model used by the ARStack simulator parity work. The values below are measured capture evidence, not generic IEC 61850 constants.
...
Internal regression must lock the measured behavior without converting model-specific counts into generic protocol constants. The SIPROTEC fixture should prove the exact capture shape where appropriate:
...
Final closure still requires a real IEDScout retest against an ARStack RC. Simulator/unit/CI evidence alone is not external interoperability proof.
