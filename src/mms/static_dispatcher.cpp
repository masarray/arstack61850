...
[[nodiscard]] bool use_declaration_order(
    ...
    // namespaces rather than positional values; keep their stable lexical
    // ordering so dynamic RP/BR/SG/CO service namespaces are never hidden
    // behind finite SCL source-order metadata.
