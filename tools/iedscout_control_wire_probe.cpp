...
int main(int argc, char** argv) {
    try {
        if (argc < 4) {
            std::cerr
                << "Usage: ariec61850_iedscout_control_wire_probe "
                   "<host> <port> <domain>\n";
            return 2;
        }
        ...
        // Mirrors the real OMICRON capture: ctlNum remains zero while Oper gets
